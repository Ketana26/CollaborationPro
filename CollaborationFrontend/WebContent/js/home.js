...
Chatbucket.service('fileUpload', ['$http','$location', function ($http,$scope,$location) {
	this.uploadFileToUrl = function(file, uploadUrl,name,password,address,dob,email,contact){
	       var fd = new FormData();
...
Chatbucket.controller('registerController', ['$scope', 'fileUpload', function($scope,fileUpload){
    $scope.register = function(){
       ...
       console.log('file is ' );
       console.dir(file);
       var uploadUrl = "http://localhost:1010/CollaborationBackend/fileUpload";
       fileUpload.uploadFileToUrl(file, uploadUrl,name,password,address,dob,email,contact);
	  ...
	  ChatService.receive().then(null, null, function(message) {
		...
		Chatbucket.controller("JobsController",function($scope,$http)
			...
			$scope.addJ=function()
			{
				...
				var res=$http.post("http://localhost:1010/CollaborationBackend/addJobs",jobs);
				...
				Chatbucket.controller("loginController",['$cookieStore','$scope','$http','$location','$rootScope',function($cookieStore,$scope,$http,$location,$rootScope)
					...
					$http.post("http://localhost:1010/CollaborationBackend/authenticate",logi).then(function(response)
							{
				...
				Chatbucket.controller("blogController",function($scope,$http,$rootScope)	
					...
					$http.get("http://localhost:1010/CollaborationBackend/viewMyBlogs/"+$rootScope.uname)
							 ...
							 $scope.newBlog={};
								...
								$scope.addBlog=function(newBlog)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:1010/CollaborationFrontend/addBlog',dataObj);
									 $http.get("http://localhost:1010/CollaborationBackend/viewMyBlogs/"+$rootScope.uname)
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:1010/CollaborationBackend/updateBlog",edit);
					$http.get("http://localhost:1010/CollaborationBackend/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				$http.post("http://localhost:1010/CollaborationBackend/deleteBlog",del);
					$http.get("http://localhost:1010/CollaborationBackend/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				Chatbucket.controller("adminBlogController",function($scope,$http,$rootScope)	
					...
					console.log(" in adminblog controller");
							 ...
							 $http.get("http://localhost:1010/CollaborationBackend/viewBlogs")
							    .then(function (response) {
				...
				Chatbucket.controller("adminJobsController",function($scope,$http,$rootScope)	
					...
					console.log(" in jobs controller");
							 ...
							 $http.get("http://localhost:1010/CollaborationBackend/viewJobs")
							    .then(function (response) {
							 ...
							 $scope.newJobs={};
								...
								$scope.addJobs=function(newJobs)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:1010/CollaborationBackend/addJobs',dataObj);
									 $http.get("http://localhost:1010/CollaborationBackend/viewJobs")
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:1010/CollaborationBackend/updateJob",edit);
					 $http.get("http://localhost:1010/CollaborationBackend/viewJobs")
					    .then(function (response) {
				...
				$http.post("http://localhost:1010/CollaborationBackend/deleteJob",del);
					 $http.get("http://localhost:1010/CollaborationBackend/viewJobs")
					    .then(function (response) {
				...
				Chatbucket.controller('logoutController',function($scope,$rootScope,$http,$cookieStore)		
						{
					$http.post("http://localhost:1010/CollaborationBackend/logout/"+$rootScope.uname);
				...
				Chatbucket.controller("adminForumController",function($scope,$http,$rootScope)	
					...
					console.log(" in adminforum controller");
							 ...
							 $http.get("http://localhost:1010/CollaborationBackend/viewForums")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.addForum=function(newForum)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:1010/CollaborationBackend/addForum',dataObj);
									 $http.get("http://localhost:1010/CollaborationFrontend/viewForums")
				...
				$scope.approveForum=function()
				{
					...
					$http.put("http://localhost:1010/CollaborationBackend/updateForum",edit);
					 $http.get("http://localhost:1010/CollaborationBackend/viewForums")
					    .then(function (response) {
				...
				Chatbucket.controller("userForumController",function($scope,$http,$rootScope)	
					...
					console.log(" in forum controller");
							 ...
							 $http.get("http://localhost:1010/CollaborationBackend/viewForum")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.answer=function(forum)
								{
									...
									answer:$scope.answerforum.answer
									 ...
									 $http.post('http://localhost:1010/CollaborationBackend/answerForum',ans);
									$http.get("http://localhost:1010/CollaborationBackend/viewForum")
								    .then(function (response) {
								...
								$scope.viewanswers=function(forum)
								{
									...
									console.log("forumid:"+$scope.answerforum.forum_id);
									 $http.get("http://localhost:1010/CollaborationBackend/viewAnswers/"+$scope.answerforum.forum_id)
									    .then(function (response) {
				...
				$http.post("http://localhost:1010/CollaborationBackend/deleteForum",del)
				...
				Chatbucket.controller("userHomeController",function($scope,$http,$rootScope)	
					...
					console.log("name in  findfriends:"+$rootScope.uname);
							 $http.get("http://localhost:1010/CollaborationBackend/findFriends/"+$rootScope.uname)
							    .then(function (response) {
					...
					$scope.addfriend=function(user)
					{
						...
						$http.post("http://localhost:1010/CollaborationBackend/addFriend/",fr);
				...
				Chatbucket.controller("friendslistController",function($scope,$http,$rootScope)	
					...
					console.log("name in  friendslist:"+$rootScope.uname);
							 $http.get("http://localhost:1010/CollaborationBackend/viewFriends/"+$rootScope.uname)
							    .then(function (response) {
				...
				Chatbucket.controller("allblogsController",function($scope,$http,$rootScope,$route)	
					...
					console.log("username in allblog controller:"+$rootScope.uname);
							 $http.get("http://localhost:1010/CollaborationBackend/viewAllBlogs")
							    .then(function (response) {
							 ...
							 { 
						       ...
						       var like=
								...
								console.log("postedby:"+$rootScope.uname);
								 $http.put('http://localhost:1010/CollaborationBackend/updateBlog',like);
								 $http.get("http://localhost:1010/CollaborationBackend/viewBlogs")
								    .then(function (response) {
					 ...
					 $http.get("http://localhost:1010/CollaborationBackend/viewComments/"+$scope.viewcomments.blog_id)
								    .then(function (response) {
						...
						$scope.comment=function(allblogs)
						{
							...
							$http.post('http://localhost:1010/CollaborationBackend/addComment',comment);
							 $http.get("http://localhost:1010/CollaborationBackend/viewBlogs")
							    .then(function (response) {
